    ...
    var hiveOutTableModify = {
        ...
        checkElm: function (type) {
            ...
            if (verifyFlag) {
                ...
                hBusinessTable.alterTabNameAndComment = 0;//是否修改字段名
                hBusinessTable.alterColumns = 0;//是否修改字段描述
                ...
                hBusinessTable.tabType = "external";
